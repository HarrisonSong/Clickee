...
?>
        <script>
         	$(document).ready(function(){         		  		
         		getOfficeList();
         		/*$('#createOffice').tooltip({
         			title:'Create a new office or configure the existing offices'        			
         		});
         		$('#manageOffice').tooltip({
         			title:'Manage the offices you have created'
         		});
         		$('#managerManageRoom').tooltip({
         			title:'As an manager, you can control the office you create'
         		});
				$('#employeeManageRoom').tooltip({
					title:'As an employee, you can control the office you create'
				});
         		$('#booking').tooltip({
         			title:'The employee can book the room from the manager'
         		});*/
         		   
				//console.log($('#selectFunctions'));
				var selectOption = $('#selectFunctions').val();
				if(selectOption == "As a manager"){
					$('#manager').show();
					$('#employee').hide();
				}else{
					$('#manager').hide();
				...
				$('#selectFunctions').change(function(){		
					var selectOption = $('#selectFunctions').val();
					if(selectOption == "As a manager"){
						$('#manager').show();
						$('#employee').hide();
				...
				$('#selectionHelp').popover({
					trigger:'hover',
					placement:'bottom',
					title:'Select user type',
					content:"<strong>As a manager</strong>: you can create and manage your own offices.</br><strong>As an employee</strong>: control devices in the offices you belong to."
				});
    ...
    <body>
        ...
        <div class="container content">
			...
			<p>
				...
				<select id = "selectFunctions" style = "margin-right:10px;">
				  <option selected = "selected">As a manager</option>
				  <option>As an employee</option>
				</select>
				<img id = 'selectionHelp' src = "<?=ASSEST_URL?>desktop/img/glyphicons_194_circle_question_mark.png" style = "width:18px;height:18px;">
			</p>
           <div class="row-fluid" id = "manager" style = "min-height:300px;display:none;">
                <div class="span4">
           ...
           <div class="row-fluid" id = "employee" style = "min-height:300px;display:none;">
           		<div class = "span6 dashboardTable">
					<table class="table dashboardTable">
						<tr>
							<td><h2>1</h2></td>
           			...
           			<a type="button" id = "booking" href = "<?=site_url('desktop/user/booking')?>" class="btn btn-success btn-block"><br/><br/>Booking</a>                   
           		</div>
           		<div class = "span6 dashboardTable">
					<table class="table dashboardTable">
						<tr>
           			...
           			<a type="button" id = "employeeManageRoom" href = "<?=site_url('desktop/user/employeeControlRoom')?>" class="btn btn-success btn-block"><br/><br/>Control Rooms</a>
           		</div>
           </div>
        </div> <!-- /container -->
		  ...
		  <div class="modal-body">
			<form class = "form-horizontal">
				...
				<div class="control-group" id = "departmentGroup">
			  	 	<label class="control-label" for="department">department in the Office:</label>
			    	<div class="controls">
			  	...
			  	<div class="control-group" id  = "positionGroup">
			    	...
			    	<div class="controls">
			      		<input type="password" id="position">
